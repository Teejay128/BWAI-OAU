...
const TicketPlaceholder = forwardRef<HTMLDivElement, TicketPlaceholderProps>(
	(
		{
			image,
			bottomText,
				...
				>
					...
					>
						...
						<div className="relative mt-6 w-full">
							<img
								src={
									image || "/main-event/gdg-ticket-avatar.jpg"
								}
								alt="Event Ticket"
								className="w-full grayscale-50 object-cover aspect-square shadow-sm transition-all duration-300"
